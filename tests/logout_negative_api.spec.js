...
test('Fast route wrong HTTP methods', async ({ request }) => {
  ...
  responses.push(await request.get(`${baseURL}/api/${API_VERSION}/fast-route`, { headers }));
  responses.push(await request.put(`${baseURL}/api/${API_VERSION}/fast-route`, { headers }));
  responses.push(await request.patch(`${baseURL}/api/${API_VERSION}/fast-route`, { headers }));
  responses.push(await request.delete(`${baseURL}/api/${API_VERSION}/fast-route`, { headers }));
